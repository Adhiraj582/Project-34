...
function setup() {
  ...
  superhero = new Superhero(100, 3, 250, 250);

  attach = new Throw(superhero.body, { x: 100, y: 465 });

  block1 = new Block(280, 350, 30, 40);
  block2 = new Block(280, 150, 30, 40);
  block3 = new Block(280, 200, 30, 40);
  block4 = new Block(280, 300, 30, 40);
  block5 = new Block(280, 550, 30, 40);
  block6 = new Block(430, 200, 30, 40);
  block7 = new Block(460, 150, 30, 40);
  block8 = new Block(490, 300, 30, 40);
  ...
  block9 = new Block(500, 315, 30, 40);
  block10 = new Block(540, 315, 30, 40);
  block11 = new Block(570, 315, 30, 40);
  block12 = new Block(500, 315, 30, 40);
  block13 = new Block(530, 315, 30, 40);
  block14 = new Block(560, 315, 30, 40);

  monster = new Monster(700, 300, 200, 200);
